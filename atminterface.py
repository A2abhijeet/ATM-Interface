            ...
            if input_pin == user_pin:
                ...
                if choice == 1:
                    ...
                    if transfer_amt > user_balance:
                        print("Insufficient balance to transfer Rs.", transfer_amt)
                        print("Please enter a lower amount!")
                        continue
                    else:
                        print(f"Transferring Rs. {transfer_amt} to {recipient}")
                        confirm = input("Confirm? Y/N > ")
                        if confirm in ('Y', 'y'):
                            user_balance -= transfer_amt
                            print(f"Amount transferred - Rs. {transfer_amt}")
                            print("Remaining balance - Rs.", user_balance, end="\n\n\n")
                            break
                        else:
